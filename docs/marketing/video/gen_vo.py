...
LINES = [
    ("01", "Администратор ищет карточку пациента в тетрадях — уже который день."),
    ("02", "Напомнить забыли. Касса не сходится. Никто не знает, кто менял карточку. И тетрадь потеряли."),
    ...
    ("prices", "Все цены — в одном прайс-листе, без звонков уточнить стоимость."),

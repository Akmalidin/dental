...
urlpatterns = [
    ...
    path("bulk-merge/exact/preview/", views.patient_bulk_merge_exact_preview, name="patient_bulk_merge_exact_preview"),
    path("bulk-merge/exact/confirm/", views.patient_bulk_merge_exact_confirm, name="patient_bulk_merge_exact_confirm"),

...
urlpatterns = [
    ...
    path("<int:pk>/merge/search/", views.patient_merge_search, name="patient_merge_search"),
    path("<int:pk>/merge/confirm/", views.patient_merge_confirm, name="patient_merge_confirm"),
    path("<int:pk>/mark-not-duplicate/", views.patient_mark_not_duplicate, name="patient_mark_not_duplicate"),
    ...
    path("<int:pk>/payments/print/", views.patient_payments_print, name="patient_payments_print"),
    path("<int:pk>/treatments/print/", views.patient_treatments_print, name="patient_treatments_print"),
